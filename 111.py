...
#asr->声纹识别(CAM++)；ASR(SENSEVOICE-SMALL)->LLM(QWEN)->TTS(EDGETTS)
# 参数设置
...
# --- 唤醒词、声纹变量配置 ---
#设置唤醒词位置后续改成嘎巴星球之类的，这个就是调用的声纹识别的模型
...
model_dir = r"C:\Users\13489\Desktop\ASR-LLM-TTS-master (2)\ASR-LLM-TTS-master\ASR-LLM-TTS-master\SenseVoice"
model_senceVoice = AutoModel( model=model_dir, trust_remote_code=True, )

# -------- CAM++声纹识别 -- 模型加载 --------
set_SV_enroll = r'.\SpeakerVerification_DIR\enroll_wav\\'
# 指定本地模型路径
local_model_path = r'C:\Users\13489\Desktop\ASR-LLM-TTS-master (2)\ASR-LLM-TTS-master\ASR-LLM-TTS-master\cam++'
# 创建本地模型管道
...
model_name = r"C:\Users\13489\Desktop\ASR-LLM-TTS-master (2)\ASR-LLM-TTS-master\ASR-LLM-TTS-master\Qwen2.5"
