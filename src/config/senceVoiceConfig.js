...
export const getAvailableServers = () => {
  return senceVoiceConfig.servers
...
export const getWebSocketConfig = () => {
  return { ...senceVoiceConfig.websocket }
}
...
export const isFeatureEnabled = (feature) => {
  return senceVoiceConfig.features[feature] || false
}
...
export const getMessage = (key) => {
  return senceVoiceConfig.messages[key] || ''
}
